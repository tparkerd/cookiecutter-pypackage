...
def main():
    ...
    try:
        ...
        parser.add_argument("-n", "--dry-run", dest='dryrun', action="store_true", help="perform a trial run with no changes made")
        parser.add_argument("path", metavar='PATH', type=str, nargs="*", default=realpath(getcwd()), help='path containing input data')
